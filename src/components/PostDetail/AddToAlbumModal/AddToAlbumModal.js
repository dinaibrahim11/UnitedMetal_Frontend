...
import classes from './AddToAlbumModal.module.css';
        ...
        <Fragment>
            ...
            <Modal.Body>
                ...
                <div className={classes.actions__container}>
                    <Button onClick={handleCreateNewGallery} startIcon={<AddIcon />} style={{marginTop: '15px', color: '#006dac'}}>Create new album</Button>
