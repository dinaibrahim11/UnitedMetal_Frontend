...
const Comments = (props) => {
    ...
    const handleAddNewComment = () => {
        ...
        setCommentsList(prevComments => [...prevComments, {
            ...
            "date": "2021-05-24 08:09:10",
            "avatarPhoto": "https://www.kindpng.com/picc/m/78-785827_user-profile-avatar-login-account-male-user-icon.png",
            "isPhotoMine": false
        ...
        <div className={classes.sub__photo__comments__view}>
            ...
            <ul className={classes.comments}>
                {commentsList && commentsList.map(comment => (
                    ...
                    <Comment key={comment.id} commentId={comment.id} avatarPhoto={comment.avatarPhoto}
                        author={comment.author} date={comment.date}
                        commentText={comment.commentText} isPhotoMine={comment.isPhotoMine}
                        />
