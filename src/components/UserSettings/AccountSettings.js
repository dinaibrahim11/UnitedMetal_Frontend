...
<ul>
    <li><Link color="blue" to="/ReqEmailChange"   style={{ textDecoration: 'none' }}>Request email change</Link>
    </li> 
     </ul>
     </div>  
...
<Link color="blue" to="/Help"   style={{ textDecoration: 'none' }}> get help with your account</Link>
<text className="OR">
,or
</text>
<Link color="blue" to="/delete"   style={{ textDecoration: 'none' }}> delete your Flickr account</Link>
<text>
.
</text>
</Card>
...
<Link color="blue" to="/changeName"   style={{ textDecoration: 'none' }}> change</Link>
...
<Link color="blue" to="/whatdoesthatmean"   style={{ textDecoration: 'none' }}> What does that mean?</Link>
<div className="headersp5"></div>
<text className="WA">
Web Addresses
</text>
<div className="headersp6"></div>
<Link className="mem" color="blue" to="/memorablewebad"   style={{ textDecoration: 'none' }}>Create your own memorable Flickr web address! </Link>
<text>
